...
import 'package:oye/AllScreens/HistoryScreen.dart';
import 'package:oye/AllScreens/aboutScreen.dart';
import 'package:oye/AllScreens/profileTabPage.dart';
import 'package:oye/AllScreens/ratingScreen.dart';
import 'package:oye/AllScreens/registerationScreen.dart';
import 'package:oye/AllScreens/searchScreen.dart';
import 'package:oye/AllWidgets/CollectFareDialog.dart';
import 'package:oye/AllWidgets/Divider.dart';
import 'package:oye/AllWidgets/noDriverAvailableDialog.dart';
import 'package:oye/AllWidgets/progressDialog.dart';
import 'package:oye/Assistants/assistantMethods.dart';
import 'package:oye/Assistants/geoFireAssistant.dart';
...
import 'package:oye/Models/nearbyAvailableDrivers.dart';
...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
      ...
      if (statusRide == "ended") {
        if (event.snapshot.value["fares"] != null) {
          ...
          if (res == "close") {
            ...
            rideRequestRef = '' as DatabaseReference;
            rideStreamSubscription.cancel();
            rideStreamSubscription = '' as StreamSubscription<Event>;
            resetApp();
          }
        }
      }
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: Colors.white,
                                      fontSize: 16.0, fontFamily: "Raleway", fontWeight: FontWeight.bold,),
                                ),
                                SizedBox(
                                  height: 6.0,
                                ),
                                GestureDetector(
                                    ...
                                    child: Text("Sanaa Brands Ltd",style: TextStyle(color: Colors.white, fontFamily: "",),))
                              ],
                            ),
                          ),
                        ],
          ...
          Positioned(
            ...
            child: Row(
              children: [
                ...
                //     child: Text("Oyes",style: TextStyle(color: Colors.black,fontSize: 24.0,fontFamily: "Raleway",fontWeight: FontWeight.w800),))
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          displayToastMessage("searching Boda...", context);

                          setState(() {
                            state = "requesting";
                            carRideType = "Boda boda";
                          });
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null) ? '\Ugx ${(AssistantMethods.calculateFares(tripDirectionDetails!)) / 2}'
                                      : ''),
                                  style: TextStyle(
                                    fontFamily: "Raleway",
                                  ),
                      ...
                      GestureDetector(
                        onTap: () {
                          displayToastMessage("searching Tuku-Tuku...", context);

                          setState(() {
                            state = "requesting";
                            carRideType = "Tuku-Tuku";
                          });
                          displayRequestRideContainer();
                          availableDrivers =
                              GeoFireAssistant.nearByAvailableDriversList;
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null)
                                      ? '\Ugx ${AssistantMethods.calculateFares(tripDirectionDetails!)}'
                                      : ''),
                                  style: TextStyle(
                                    fontFamily: "Raleway",
                                  ),
                      ...
                      GestureDetector(
                        onTap: () {
                          displayToastMessage("searching PickUp Truck...", context);

                          setState(() {
                            state = "requesting";
                            carRideType = "PickUp Track";
                          });
                          displayRequestRideContainer();
                          availableDrivers =
                              GeoFireAssistant.nearByAvailableDriversList;
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null)
                                      ? '\Ugx ${(AssistantMethods.calculateFares(tripDirectionDetails!)) * 2}'
                                      : ''),
                                  style: TextStyle(
                                    fontFamily: "Raleway",
                                  ),
  ...
  Future<void> getPlaceDirection() async {
    ...
    Marker pickUpLocMarker = Marker(icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueYellow),
        ...
        switch (callBack) {
          case Geofire.onKeyEntered:
            NearbyAvailableDrivers nearbyAvailableDrivers =
                NearbyAvailableDrivers(latitude: 0, key: '', longitude: 0);
