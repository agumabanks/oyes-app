...
class IInputField2 extends StatefulWidget {
  ...
  IInputField2({required this.hint, required this.icon, required this.controller, required this.type, required this.colorDefaultText, required this.colorBackground,
    required this.onPressRightIcon, required this.onChangeText});
